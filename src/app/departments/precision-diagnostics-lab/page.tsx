    ...
    return(
        <div className="flex flex-col items-center justify-center text-white px-2 sm:px-6 md:px-10">
            ...
            <div className="flex items-start flex-col">
                ...
                <ul className="text-sm sm:text-md md:text-lg mt-4 ps-1 text-start">
                    <li>&bull; Precision Diagnostics Lab - Smart Diagnostic Room.</li>
                    <li>&bull; Precision in Diagnosis, Confidence in Treatment.</li>
                </ul>
                <p className="text-sm sm:text-md md:text-lg mt-4 px-2 sm:px-4 md:px-6 lg:px-10">
                ...
                <div>
                    <h2 className="text-lg sm:text-xl lg:text-2xl text-main-color text-start">
                        &bull; What does Precision Diagnostics Lab Offer?
                    </h2>
                    <ul>
                        <li className="flex items-center text-md sm:text-lg md:text-xl">
