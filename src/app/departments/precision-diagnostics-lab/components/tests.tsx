...
export const Tests = () => {
    return(
        <div className="px-2 sm:px-6 md:px-10 text-black">
            ...
            <ul>
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; Visia AI Skin Analysis</h3>
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; Foto Finder AI Hair Analysis</h3>
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull;  InBody Body Composition Analysis.</h3>
                ...
                <li><h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; Oligoscan & FDA-Approved Vitamin Deficiency Test - 
                    ...
                    <p className="ps-4 text-md sm:text-lg md:text-xl">This combined test utilizes advanced medical technology to assess essential mineral and 
                        ...
                        💉 <span className="underline">FDA-Approved</span> Vitamin Deficiency Test is a laboratory blood analysis certified by the FDA, measuring Vitamin D, B12, Iron, 
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; Blood Pressure & Glucose Test.</h3>
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; 3D Digital Dental Scan</h3>
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; Functional Consultations & Health Tests</h3>
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull;  DNA Genetic Analysis</h3>
...
Helps design a tailored lifestyle plan based on genetic markers, optimizing preventive healthcare and nutrition strategies.</p>
                ...
                <li>
                    <h3 className="text-lg sm:text-xl lg:text-2xl text-main-color">&bull; Food Allergy Test</h3>
