...
export const SkinBrightening = () => {
    const [isShow, setIsShow] = useState(false);
    const items = [
        "Body Lightening",
        "Intimate Brightening",
        "Decolletage Whitening & Anti-Aging",
    ];

    return(
        <div className="my-6">
            <h1 className="text-lg sm:text-xl lg:text-2xl text-main-color">
                &bull; Skin Brightening
            </h1>
            <h3 className="ps-4 text-white text-md sm:text-lg lg:text-xl">
                Bid farewell to dullness and uneven tone with our advanced Skin Brightening Treatments, designed to reveal a luminous, radiant complexion.
            </h3>
            <button 
