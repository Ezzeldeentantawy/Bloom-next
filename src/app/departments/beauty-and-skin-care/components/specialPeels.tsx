    ...
    return(
        <div className="my-6">
            ...
            <h3 className="ps-4 text-white text-md sm:text-lg lg:text-xl">
                Transform dull, damaged skin with our professional Chemical Peels – the ultimate resurfacing treatment for a fresher, more youthful complexion.
            </h3>
            <button 
