    ...
    return(
        <div className="my-6">
            <h1 className="text-lg sm:text-xl lg:text-2xl text-main-color">
                &bull; Deep Cleansing & Revitalization
            </h1>
            <h3 className="ps-4 text-white text-md sm:text-lg lg:text-xl">
                Indulge in our ultimate skin detox! This intensive treatment goes beyond surface-level 
                cleansing, using advanced exfoliation, steam extraction, 
                and deep-pore purification to remove impurities, excess oil, and dead skin cells. 
            </h3>
            <button 
