...
export function BookNowCard() {
    return (
        <div className="bg-white rounded-2xl shadow-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 max-w-4xl mx-auto mb-16 border-2 border-[#fac06a]">
