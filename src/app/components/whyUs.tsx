export default function WhyUs() {
    return (
        <section className="why-shadow py-12 px-6 md:px-20 my-5" id="Whyus">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div className="flex flex-col items-center">
                    <svg className="w-12 h-12 text-red-500 mb-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    ...
                    <p className="text-white mt-2">Certified professionals dedicated to your skincare and beauty goals.</p>
                </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-white mt-2">We use the latest equipment to deliver safe, effective treatments.</p>
                </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-white mt-2">Tailored skincare plans that suit your unique skin type and needs.</p>
                </div>
            </div>
        </section>
    );
