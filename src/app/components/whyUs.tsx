    ...
    return (
        ...
        >
            <div className="text-center mb-10">
                <h2 className="text-2xl sm:text-[26px] md:text-[28px] font-bold text-main-color">Why Choose Us?</h2>
                <p className="text-black mt-2 text-xl sm:text-[22px] md:text-[24px]">Discover what sets our beauty clinic apart</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-lg sm:text-xl md:text-[22px] font-semibold text-main-color">Expert Team</h3>
                    <p className="text-black text-base sm:text-[18px] md:text-[20px] mt-2">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-lg sm:text-xl md:text-[22px] font-semibold text-main-color">Advanced Technology</h3>
                    <p className="text-black text-base sm:text-[18px] md:text-[20px] mt-2">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-lg sm:text-xl md:text-[22px] font-semibold text-main-color">Personalized Treatments</h3>
                    <p className="text-black text-base sm:text-[18px] md:text-[20px] mt-2">
