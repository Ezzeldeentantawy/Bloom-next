...
export const metadata: Metadata = {
  ...
  description: 'Top-rated beauty clinic & medical center in UAE offering laser hair removal, hydrafacial, skin rejuvenation, botox, filler and more. Book your consultation today!',
...
export default function Home() {
  return (
    <>
      ...
      <div className="text-center font-merriweather relative">
        <Header />
